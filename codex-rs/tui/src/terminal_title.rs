...
//! "leave the old title alone" or "clear the title Darwin-Code last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Darwin-Code manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Darwin-Code started managing the title.
