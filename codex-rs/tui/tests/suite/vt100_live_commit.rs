...
fn live_001_commit_on_overflow() {
    ...
    let mut term = match darwin_code_tui::Terminal::with_options(backend) {
        Ok(t) => t,
    ...
    let mut rb = darwin_code_tui::RowBuilder::new(/*target_width*/ 20);
    ...
    darwin_code_tui::insert_history_lines(&mut term, lines)
