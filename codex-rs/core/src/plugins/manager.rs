...
use darwin_code_core_plugins::loader::configured_curated_plugin_ids_from_codex_home;
...
use darwin_code_core_plugins::loader::load_plugin_skills;
...
use darwin_code_core_plugins::loader::materialize_marketplace_plugin_source;
use darwin_code_core_plugins::loader::plugin_telemetry_metadata_from_root;
use darwin_code_core_plugins::loader::refresh_curated_plugin_cache;
...
use darwin_code_core_plugins::manifest::load_plugin_manifest;
use darwin_code_core_plugins::marketplace::MarketplaceError;
use darwin_code_core_plugins::marketplace::MarketplaceInterface;
use darwin_code_core_plugins::marketplace::MarketplaceListError;
use darwin_code_core_plugins::marketplace::MarketplacePluginAuthPolicy;
use darwin_code_core_plugins::marketplace::MarketplacePluginPolicy;
use darwin_code_core_plugins::marketplace::MarketplacePluginSource;
use darwin_code_core_plugins::marketplace::ResolvedMarketplacePlugin;
use darwin_code_core_plugins::marketplace::find_installable_marketplace_plugin;
use darwin_code_core_plugins::marketplace::find_marketplace_plugin;
use darwin_code_core_plugins::marketplace::list_marketplaces;
use darwin_code_core_plugins::marketplace::load_marketplace;
use darwin_code_core_plugins::marketplace::plugin_interface_with_marketplace_category;
use darwin_code_core_plugins::marketplace_upgrade::ConfiguredMarketplaceUpgradeError;
use darwin_code_core_plugins::marketplace_upgrade::ConfiguredMarketplaceUpgradeOutcome;
use darwin_code_core_plugins::marketplace_upgrade::configured_git_marketplace_names;
use darwin_code_core_plugins::marketplace_upgrade::upgrade_configured_git_marketplaces;
use darwin_code_core_plugins::remote::RemotePluginFetchError;
use darwin_code_core_plugins::remote::RemotePluginMutationError;
use darwin_code_core_plugins::remote::RemotePluginServiceConfig;
use darwin_code_core_plugins::store::PluginInstallResult as StorePluginInstallResult;
...
fn remote_plugin_service_config(_config: &Config) -> RemotePluginServiceConfig {
    RemotePluginServiceConfig::default()
}

fn featured_plugin_ids_cache_key(_config: &Config) -> FeaturedPluginIdsCacheKey {
...
pub enum PluginRemoteSyncError {
    #[error("remote plugin sync is disabled in BYOK-only mode")]
    AuthRequired,
...
impl From<RemotePluginFetchError> for PluginRemoteSyncError {
    fn from(value: RemotePluginFetchError) -> Self {
        match value {
            RemotePluginFetchError::UnavailableInByokMode => Self::UnsupportedAuthMode,
        }
    }
}
...
impl PluginsManager {
    ...
    pub async fn featured_plugin_ids_for_config<A>(
        &self,
        config: &Config,
        _auth: Option<&A>,
        ...
        let cache_key = featured_plugin_ids_cache_key(config);
        ...
        let featured_plugin_ids =
            darwin_code_core_plugins::remote::fetch_remote_featured_plugin_ids(
    ...
    pub async fn install_plugin_with_remote_sync<A>(
        &self,
        config: &Config,
        _auth: Option<&A>,
        request: PluginInstallRequest,
        ...
        darwin_code_core_plugins::remote::enable_remote_plugin(
            &remote_plugin_service_config(config),
            &plugin_id,
        )
        .await
    ...
    pub async fn uninstall_plugin_with_remote_sync<A>(
        &self,
        config: &Config,
        _auth: Option<&A>,
        plugin_id: String,
        ...
        darwin_code_core_plugins::remote::uninstall_remote_plugin(
            &remote_plugin_service_config(config),
            &plugin_key,
        )
        .await
    ...
    pub async fn sync_plugins_from_remote<A>(
        &self,
        config: &Config,
        _auth: Option<&A>,
        additive_only: bool,
        ...
        let remote_plugins = darwin_code_core_plugins::remote::fetch_remote_plugin_status(
            &remote_plugin_service_config(config),
        )
        .await
    ...
    pub(crate) async fn read_plugin_detail_for_marketplace_plugin(
        ...
        let resolved_skills = load_plugin_skills(
            ...
            &manifest.paths,
            self.restriction_product,
            &darwin_code_core_skills::config_rules::skill_config_rules_from_stack(
                &config.config_layer_stack,
            ),
        )
        .await;
    ...
    pub fn maybe_start_plugin_startup_tasks_for_config(self: &Arc<Self>, config: &Config) {
        if config.features.enabled(Feature::Plugins) {
            ...
            // BYOK-only DarwinCode does not sync account-backed remote plugins at startup.
            let config = config.clone();
            let manager = Arc::clone(self);
