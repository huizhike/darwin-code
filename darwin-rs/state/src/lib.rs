...
//! orchestration and rollout scanning live in `darwin-code-core`.
...
pub const SQLITE_HOME_ENV: &str = "DARWIN_CODE_SQLITE_HOME";
...
pub const DB_ERROR_METRIC: &str = "darwin.db.error";
/// Metrics on backfill process. Tags: [status]
pub const DB_METRIC_BACKFILL: &str = "darwin.db.backfill";
/// Metrics on backfill duration. Tags: [status]
pub const DB_METRIC_BACKFILL_DURATION_MS: &str = "darwin.db.backfill.duration_ms";
