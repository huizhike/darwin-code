...
//! `schemars`) so they can be embedded in DarwinCode's own protocol structures.
...
// === Adapter helpers ===
//
// These types and conversions intentionally live in `darwin-code-protocol` so other crates can convert
