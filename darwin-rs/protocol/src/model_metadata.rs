//! Shared model metadata types exchanged between DarwinCode services and clients.
//!
...
/// Metadata describing a DarwinCode-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
pub struct ModelPreset {
    ...
    pub model: String,
    /// Provider id that owns this model when sourced from BYOK config.
...
/// Model metadata returned by the DarwinCode backend `/models` endpoint.
