...
use crate::RequestId;
use darwin_code_experimental_api_macros::ExperimentalApi;
...
use darwin_code_protocol::model_metadata::ModelAvailabilityNux as CoreModelAvailabilityNux;
use darwin_code_protocol::model_metadata::ReasoningEffort;
use darwin_code_protocol::model_metadata::default_input_modalities;
...
/// This translation layer make sure that we expose darwin error code in camel case.
///
/// When an upstream HTTP status is available (for example, from the Responses API or a provider),
/// it is forwarded in `httpStatusCode` on the relevant `darwinErrorInfo` variant.
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, JsonSchema, TS)]
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub enum DarwinCodeErrorInfo {
...
impl From<CoreDarwinCodeErrorInfo> for DarwinCodeErrorInfo {
    fn from(value: CoreDarwinCodeErrorInfo) -> Self {
        match value {
            CoreDarwinCodeErrorInfo::ContextWindowExceeded => {
                DarwinCodeErrorInfo::ContextWindowExceeded
            }
            CoreDarwinCodeErrorInfo::UsageLimitExceeded => DarwinCodeErrorInfo::UsageLimitExceeded,
            CoreDarwinCodeErrorInfo::ServerOverloaded => DarwinCodeErrorInfo::ServerOverloaded,
            CoreDarwinCodeErrorInfo::HttpConnectionFailed { http_status_code } => {
                DarwinCodeErrorInfo::HttpConnectionFailed { http_status_code }
            }
            CoreDarwinCodeErrorInfo::ResponseStreamConnectionFailed { http_status_code } => {
                DarwinCodeErrorInfo::ResponseStreamConnectionFailed { http_status_code }
            }
            CoreDarwinCodeErrorInfo::InternalServerError => {
                DarwinCodeErrorInfo::InternalServerError
            }
            CoreDarwinCodeErrorInfo::Unauthorized => DarwinCodeErrorInfo::Unauthorized,
            CoreDarwinCodeErrorInfo::BadRequest => DarwinCodeErrorInfo::BadRequest,
            CoreDarwinCodeErrorInfo::ThreadRollbackFailed => {
                DarwinCodeErrorInfo::ThreadRollbackFailed
            }
            CoreDarwinCodeErrorInfo::SandboxError => DarwinCodeErrorInfo::SandboxError,
            CoreDarwinCodeErrorInfo::ResponseStreamDisconnected { http_status_code } => {
                DarwinCodeErrorInfo::ResponseStreamDisconnected { http_status_code }
            }
            CoreDarwinCodeErrorInfo::ResponseTooManyFailedAttempts { http_status_code } => {
                DarwinCodeErrorInfo::ResponseTooManyFailedAttempts { http_status_code }
            }
            CoreDarwinCodeErrorInfo::ActiveTurnNotSteerable { turn_kind } => {
                DarwinCodeErrorInfo::ActiveTurnNotSteerable {
                    turn_kind: turn_kind.into(),
                }
            }
            CoreDarwinCodeErrorInfo::Other => DarwinCodeErrorInfo::Other,
        }
    }
}
...
pub enum ConfigLayerSource {
    ...
    /// User config layer from $DARWIN_CODE_HOME/config.toml. This layer is special
    ...
    /// Path to a .darwin/ folder within a project. There could be multiple of
...
pub struct ExternalAgentConfigDetectParams {
    /// If true, include detection under the user's home (~/.claude, ~/.darwin, etc.).
    #[serde(default, skip_serializing_if = "std::ops::Not::not")]
...
pub struct ThreadStartParams {
    ...
    /// This is for internal use only (e.g. DarwinCode Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR DARWIN_CODE CLOUD - DO NOT USE.
...
pub struct Thread {
    ...
    /// Origin of the thread (CLI, VSCode, darwin exec, darwin app-server, etc.).
...
pub struct TurnError {
    pub message: String,
    pub darwin_code_error_info: Option<DarwinCodeErrorInfo>,
    #[serde(default)]
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active DarwinCode turn when this elicitation was observed, if app-server could correlate one.
    ///
...
mod tests {
        ...
        let user_item = TurnItem::UserMessage(UserMessageItem {
            ...
            content: vec![
                ...
                CoreUserInput::Skill {
                    ...
                    path: PathBuf::from("/repo/.darwin/skills/skill-creator/SKILL.md"),
                },
    ...
    fn plugin_uninstall_params_serialization_omits_force_remote_sync() {
        assert_eq!(
            serde_json::to_value(PluginUninstallParams {
                plugin_id: "gmail@local".to_string(),
            })
            .unwrap(),
            json!({
                "pluginId": "gmail@local",
            }),
        );
    ...
    #[test]
    fn darwin_code_error_info_serializes_http_status_code_in_camel_case() {
        let value = DarwinCodeErrorInfo::ResponseTooManyFailedAttempts {
    ...
    #[test]
    fn darwin_code_error_info_serializes_active_turn_not_steerable_turn_kind_in_camel_case() {
        let value = DarwinCodeErrorInfo::ActiveTurnNotSteerable {
