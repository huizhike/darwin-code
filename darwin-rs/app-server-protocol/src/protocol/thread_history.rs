...
impl ThreadHistoryBuilder {
    ...
    /// See `should_persist_event_msg` in `darwin-rs/core/rollout/policy.rs`.
    ...
    fn handle_error(&mut self, payload: &ErrorEvent) {
        ...
        turn.error = Some(V2TurnError {
            ...
            darwin_code_error_info: payload.darwin_code_error_info.clone().map(Into::into),
        ...
        let events = vec![
            ...
            EventMsg::CollabAgentSpawnEnd(
                darwin_code_protocol::protocol::CollabAgentSpawnEndEvent {
                    ...
                    reasoning_effort: darwin_code_protocol::model_metadata::ReasoningEffort::Medium,
        ...
        assert_eq!(
            ...
            ThreadItem::CollabAgentToolCall {
                ...
                reasoning_effort: Some(
                    darwin_code_protocol::model_metadata::ReasoningEffort::Medium
                ),
                agents_states: [(
                    "00000000-0000-0000-0000-000000000002".into(),
                    CollabAgentState {
    ...
    fn error_then_turn_complete_preserves_failed_status() {
        let events = vec![
            ...
            EventMsg::Error(ErrorEvent {
                ...
                darwin_code_error_info: Some(DarwinCodeErrorInfo::ResponseStreamDisconnected {
        ...
        assert_eq!(
            ...
            Some(TurnError {
                message: "stream failure".into(),
                darwin_code_error_info: Some(
                    crate::protocol::v2::DarwinCodeErrorInfo::ResponseStreamDisconnected {
                        http_status_code: Some(502),
                    }
                ),
                additional_details: None,
