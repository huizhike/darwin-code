...
/// Superset of [`darwin_code_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by DarwinCode Cloud.
            ...
            json!({
                ...
                "params": {
                    "clientInfo": {
                        ...
                        "title": "DarwinCode VS Code Extension",
                        "version": "0.1.0"
                    },
                    "capabilities": {
