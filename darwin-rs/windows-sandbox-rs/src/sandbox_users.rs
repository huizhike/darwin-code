...
use darwin_code_windows_sandbox::dpapi_protect;
...
pub const SANDBOX_USERS_GROUP: &str = "DarwinCodeSandboxUsers";
const SANDBOX_USERS_GROUP_COMMENT: &str = "DarwinCode sandbox internal group (managed)";
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(darwin_code_home);
    ...
    let secrets_dir = sandbox_secrets_dir(darwin_code_home);
