...
//! darwin home directory creation and git safe.directory injection so sandboxed
...
/// Ensure the sandbox darwin home directory exists.
pub fn ensure_darwin_code_home_exists(p: &Path) -> Result<()> {
