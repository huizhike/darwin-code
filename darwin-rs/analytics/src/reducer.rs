...
use crate::events::DarwinCodeTurnEventParams;
use crate::events::DarwinCodeTurnEventRequest;
use crate::events::DarwinCodeTurnSteerEventParams;
use crate::events::DarwinCodeTurnSteerEventRequest;
...
use crate::events::darwin_code_compaction_event_params;
...
struct CompletedTurnState {
    ...
    turn_error: Option<DarwinCodeErrorInfo>,
    completed_at: u64,
...
impl AnalyticsReducer {
    ...
    fn ingest_guardian_review(
        ...
        out.push(TrackEventRequest::GuardianReview(Box::new(
            GuardianReviewEventRequest {
                event_type: "darwin_code_guardian_review",
    ...
    fn ingest_app_mentioned(&mut self, input: AppMentionedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.extend(mentions.into_iter().map(|mention| {
            let event_params = darwin_code_app_metadata(&tracking, mention);
            TrackEventRequest::AppMentioned(DarwinCodeAppMentionedEventRequest {
    ...
    fn ingest_app_used(&mut self, input: AppUsedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        let event_params = darwin_code_app_metadata(&tracking, app);
        out.push(TrackEventRequest::AppUsed(DarwinCodeAppUsedEventRequest {
    ...
    fn ingest_hook_run(&mut self, input: HookRunInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::HookRun(DarwinCodeHookRunEventRequest {
            event_type: "darwin_code_hook_run",
            event_params: darwin_code_hook_run_metadata(&tracking, hook),
        }));
    }
    ...
    fn ingest_plugin_used(&mut self, input: PluginUsedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::PluginUsed(
            DarwinCodePluginUsedEventRequest {
                event_type: "darwin_code_plugin_used",
                event_params: darwin_code_plugin_used_metadata(&tracking, plugin),
            },
        ));
    }
    ...
    fn ingest_plugin_state_changed(
        ...
        let event = DarwinCodePluginEventRequest {
            event_type: plugin_state_event_type(state),
            event_params: darwin_code_plugin_metadata(plugin),
        };
            ...
            ServerNotification::TurnCompleted(notification) => {
                ...
                turn_state.completed = Some(CompletedTurnState {
                    ...
                    turn_error: notification
                        .turn
                        .error
                        .and_then(|error| error.darwin_code_error_info),
    ...
    fn ingest_compaction(
        ...
        out.push(TrackEventRequest::Compaction(Box::new(
            DarwinCodeCompactionEventRequest {
                event_type: "darwin_code_compaction_event",
                event_params: darwin_code_compaction_event_params(
                    input,
    ...
    fn emit_turn_steer_event(
        ...
        out.push(TrackEventRequest::TurnSteer(
            DarwinCodeTurnSteerEventRequest {
                event_type: "darwin_code_turn_steer_event",
                event_params: DarwinCodeTurnSteerEventParams {
                    thread_id: pending_request.thread_id,
    ...
    fn maybe_emit_turn_event(&mut self, turn_id: &str, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::TurnEvent(Box::new(
            DarwinCodeTurnEventRequest {
                event_type: "darwin_code_turn_event",
                event_params: darwin_code_turn_event_params(
                    app_server_client,
                    runtime,
                    turn_id.to_string(),
                    turn_state,
...
fn darwin_code_turn_event_params(
    app_server_client: DarwinCodeAppServerClientMetadata,
    runtime: DarwinCodeRuntimeMetadata,
    turn_id: String,
    turn_state: &TurnState,
    thread_metadata: &ThreadMetadataState,
) -> DarwinCodeTurnEventParams {
...
fn analytics_turn_status(
    status: darwin_code_app_server_protocol::TurnStatus,
) -> Option<TurnStatus> {
    match status {
        darwin_code_app_server_protocol::TurnStatus::Completed => Some(TurnStatus::Completed),
        darwin_code_app_server_protocol::TurnStatus::Failed => Some(TurnStatus::Failed),
        darwin_code_app_server_protocol::TurnStatus::Interrupted => Some(TurnStatus::Interrupted),
        darwin_code_app_server_protocol::TurnStatus::InProgress => None,
    }
}
