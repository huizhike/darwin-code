...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(DarwinCodeAppMentionedEventRequest),
    AppUsed(DarwinCodeAppUsedEventRequest),
    HookRun(DarwinCodeHookRunEventRequest),
    Compaction(Box<DarwinCodeCompactionEventRequest>),
    TurnEvent(Box<DarwinCodeTurnEventRequest>),
    TurnSteer(DarwinCodeTurnSteerEventRequest),
    PluginUsed(DarwinCodePluginUsedEventRequest),
    PluginInstalled(DarwinCodePluginEventRequest),
    PluginUninstalled(DarwinCodePluginEventRequest),
    PluginEnabled(DarwinCodePluginEventRequest),
    PluginDisabled(DarwinCodePluginEventRequest),
}
...
pub(crate) struct DarwinCodeAppServerClientMetadata {
...
#[derive(Clone, Serialize)]
pub(crate) struct DarwinCodeRuntimeMetadata {
    pub(crate) darwin_code_rs_version: String,
...
pub(crate) struct ThreadInitializedEventParams {
    ...
    pub(crate) app_server_client: DarwinCodeAppServerClientMetadata,
    pub(crate) runtime: DarwinCodeRuntimeMetadata,
...
pub enum GuardianApprovalRequestSource {
    /// Approval requested directly by the main DarwinCode turn.
    MainTurn,
...
#[derive(Serialize)]
pub(crate) struct DarwinCodeAppMetadata {
...
#[derive(Serialize)]
pub(crate) struct DarwinCodeAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: DarwinCodeAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct DarwinCodeAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: DarwinCodeAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct DarwinCodeHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct DarwinCodeHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: DarwinCodeHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct DarwinCodeCompactionEventParams {
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct DarwinCodeCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: DarwinCodeCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct DarwinCodeTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    ...
    pub(crate) turn_error: Option<DarwinCodeErrorInfo>,
...
#[derive(Serialize)]
pub(crate) struct DarwinCodeTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: DarwinCodeTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct DarwinCodeTurnSteerEventParams {
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct DarwinCodeTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: DarwinCodeTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct DarwinCodePluginMetadata {
...
#[derive(Serialize)]
pub(crate) struct DarwinCodePluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: DarwinCodePluginMetadata,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) model_slug: Option<String>,
}
...
#[derive(Serialize)]
pub(crate) struct DarwinCodePluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: DarwinCodePluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct DarwinCodePluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: DarwinCodePluginUsedMetadata,
}

pub(crate) fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "darwin_code_plugin_installed",
        PluginState::Uninstalled => "darwin_code_plugin_uninstalled",
        PluginState::Enabled => "darwin_code_plugin_enabled",
        PluginState::Disabled => "darwin_code_plugin_disabled",
    }
}

pub(crate) fn darwin_code_app_metadata(
    tracking: &TrackEventsContext,
    app: AppInvocation,
) -> DarwinCodeAppMetadata {
    DarwinCodeAppMetadata {
...
pub(crate) fn darwin_code_plugin_metadata(
    plugin: PluginTelemetryMetadata,
) -> DarwinCodePluginMetadata {
    ...
    DarwinCodePluginMetadata {
        ...
        source_name: Some(plugin.plugin_id.source_name),
...
pub(crate) fn darwin_code_compaction_event_params(
    input: DarwinCodeCompactionEvent,
    app_server_client: DarwinCodeAppServerClientMetadata,
    runtime: DarwinCodeRuntimeMetadata,
    thread_source: Option<&'static str>,
    subagent_source: Option<String>,
    parent_thread_id: Option<String>,
) -> DarwinCodeCompactionEventParams {
    DarwinCodeCompactionEventParams {
...
pub(crate) fn darwin_code_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> DarwinCodePluginUsedMetadata {
    DarwinCodePluginUsedMetadata {
        plugin: darwin_code_plugin_metadata(plugin),
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        model_slug: Some(tracking.model_slug.clone()),
    }
...
pub(crate) fn darwin_code_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> DarwinCodeHookRunMetadata {
    DarwinCodeHookRunMetadata {
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        model_slug: Some(tracking.model_slug.clone()),
...
pub(crate) fn current_runtime_metadata() -> DarwinCodeRuntimeMetadata {
    let os_info = os_info::get();
    DarwinCodeRuntimeMetadata {
        darwin_code_rs_version: env!("CARGO_PKG_VERSION").to_string(),
