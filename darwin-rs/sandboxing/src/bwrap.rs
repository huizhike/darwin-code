...
const MISSING_BWRAP_WARNING: &str = concat!(
    "DarwinCode could not find bubblewrap on PATH. ",
    "Install bubblewrap with your OS package manager. ",
    "See the sandbox prerequisites: ",
    "https://docs.darwin.local/darwin-code/concepts/sandboxing#prerequisites. ",
    "DarwinCode will use the vendored bubblewrap in the meantime.",
);
const USER_NAMESPACE_WARNING: &str =
    "DarwinCode's Linux sandbox uses bubblewrap and needs access to create user namespaces.";
pub(crate) const WSL1_BWRAP_WARNING: &str = concat!(
    "DarwinCode's Linux sandbox uses bubblewrap, which is not supported on WSL1 ",
