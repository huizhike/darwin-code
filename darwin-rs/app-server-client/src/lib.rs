...
/// module exists so clients can remove a direct `darwin-code-core` dependency
...
impl InProcessClientStartArgs {
    ...
    fn into_runtime_start_args(self) -> InProcessStartArgs {
        ...
        InProcessStartArgs {
            ...
            enable_darwin_code_api_key_env: self.enable_darwin_code_api_key_env,
            initialize,
...
mod tests {
    ...
    async fn start_test_client_with_capacity(
        ...
        InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            client_name: "darwin-code-app-server-client-test".to_string(),
