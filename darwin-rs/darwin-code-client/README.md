...
Generic transport layer that wraps HTTP requests, retries, and streaming primitives without any Darwin Code/model-provider awareness.
...
- Consumed by higher-level crates like `darwin-code-api`; it stays neutral on endpoints, headers, or API-specific error shapes.
