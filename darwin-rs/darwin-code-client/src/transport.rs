use crate::default_client::DarwinCodeHttpClient;
use crate::default_client::DarwinCodeRequestBuilder;
...
pub struct ReqwestTransport {
    client: DarwinCodeHttpClient,
}

impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: DarwinCodeHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<DarwinCodeRequestBuilder, TransportError> {
        let Request {
            method,
            url,
            mut headers,
