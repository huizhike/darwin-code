...
pub(crate) struct PreToolUseCommandInput {
    ...
    /// DarwinCode extension: expose the active turn id to internal turn-scoped hooks.
    pub turn_id: String,
...
mod tests {
    ...
    #[test]
    fn turn_scoped_hook_inputs_include_darwin_code_turn_id_extension() {
        // DarwinCode intentionally diverges from Claude's public hook docs here so
