...
impl SkillsManager {
    pub fn new(darwin_code_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&manager.darwin_code_home);
        } else if let Err(err) = install_system_skills(&manager.darwin_code_home) {
