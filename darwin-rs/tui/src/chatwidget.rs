...
type FeedbackClient = darwin_code_feedback::DarwinCodeFeedback;
...
const MEMORIES_DOC_URL: &str = "https://docs.darwin.local/darwin-code/memories";
...
impl ChatWidget {
    ...
    fn handle_steer_rejected_error(
        &mut self,
        darwin_code_error_info: &CoreDarwinCodeErrorInfo,
    ) -> bool {
        matches!(
    ...
    pub(crate) fn open_windows_sandbox_enable_prompt(&mut self, preset: ApprovalPreset) {
        ...
        if !crate::legacy_core::windows_sandbox::ELEVATED_SANDBOX_NUX_ENABLED {
            ...
            header.push(*Box::new(
                Paragraph::new(vec![
                    ...
                    line!["Learn more: https://docs.darwin.local/darwin-code/windows"],
                ])
        ...
        header.push(*Box::new(
            Paragraph::new(vec![
                line!["Set up the DarwinCode agent sandbox to protect your files and control network access. Learn more <https://docs.darwin.local/darwin-code/windows>"],
            ])
            .wrap(Wrap { trim: false }),
        ));
    ...
    pub(crate) fn open_windows_sandbox_fallback_prompt(&mut self, preset: ApprovalPreset) {
        ...
        lines.push(line![
            "Learn more <https://docs.darwin.local/darwin-code/windows>"
        ]);
