...
use darwin_code_protocol::model_metadata::ModelUpgrade;
...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) reasoning_effort: Option<darwin_code_protocol::model_metadata::ReasoningEffort>,
...
async fn thread_session_state_from_thread_response(
    ...
    reasoning_effort: Option<darwin_code_protocol::model_metadata::ReasoningEffort>,
    config: &Config,
) -> Result<ThreadSessionState, String> {
