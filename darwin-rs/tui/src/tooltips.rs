...
const ANNOUNCEMENT_TIP_URL: &str = "https://docs.darwin.local/darwin-code/announcement_tip.toml";
...
/// Pick a random tooltip to show to the user when starting DarwinCode.
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // DarwinCode currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for DarwinCode TUI.
...
[[announcements]]
content = "Welcome to DarwinCode! Check out the new onboarding flow."
