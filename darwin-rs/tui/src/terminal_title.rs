...
//! "leave the old title alone" or "clear the title DarwinCode last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title DarwinCode manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before DarwinCode started managing the title.
