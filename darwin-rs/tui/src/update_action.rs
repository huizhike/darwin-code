...
use darwin_code_install_context::InstallContext;
#[cfg(any(not(debug_assertions), test))]
use darwin_code_install_context::StandalonePlatform;

/// Update action the CLI should perform after the TUI exits.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum UpdateAction {
    /// Update via `npm install -g @darwin/darwin_code@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @darwin/darwin_code@latest`.
    BunGlobalLatest,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "@darwin/darwin_code"]),
            UpdateAction::BunGlobalLatest => ("bun", &["install", "-g", "@darwin/darwin_code"]),
