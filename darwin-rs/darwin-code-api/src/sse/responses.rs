...
fn header_provider_model_value_from_json(value: &Value) -> Option<String> {
...
mod tests {
    ...
    const CYBER_RESTRICTED_MODEL_FOR_TESTS: &str = "gpt-5.3-darwin";
}
