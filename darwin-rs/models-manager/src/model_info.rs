...
use darwin_code_protocol::model_metadata::ModelInstructionsVariables;
use darwin_code_protocol::model_metadata::ModelMessages;
use darwin_code_protocol::model_metadata::ModelVisibility;
use darwin_code_protocol::model_metadata::TruncationMode;
...
const DEFAULT_PERSONALITY_HEADER: &str = "You are DarwinCode, a coding agent based on GPT-5. You and the user share the same workspace and collaborate to achieve the user's goals.";
