//! Helpers for truncating tool and exec output using [`TruncationPolicy`](darwin_code_protocol::protocol::TruncationPolicy).

use darwin_code_protocol::models::FunctionCallOutputContentItem;
pub use darwin_code_utils_string::approx_bytes_for_tokens;
pub use darwin_code_utils_string::approx_token_count;
pub use darwin_code_utils_string::approx_tokens_from_byte_count;
use darwin_code_utils_string::truncate_middle_chars;
use darwin_code_utils_string::truncate_middle_with_token_budget;

pub use darwin_code_protocol::protocol::TruncationPolicy;
