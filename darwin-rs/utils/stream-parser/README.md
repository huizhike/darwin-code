# darwin-code-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Darwin Code did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Darwin Code on it. Feel free to update the documentation as you
modify the code
...
```rust
use darwin_code_utils_stream_parser::CitationStreamParser;
use darwin_code_utils_stream_parser::StreamTextParser;
...
```rust
use darwin_code_utils_stream_parser::CitationStreamParser;
use darwin_code_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), darwin_code_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use darwin_code_utils_stream_parser::InlineHiddenTagParser;
use darwin_code_utils_stream_parser::InlineTagSpec;
use darwin_code_utils_stream_parser::StreamTextParser;
