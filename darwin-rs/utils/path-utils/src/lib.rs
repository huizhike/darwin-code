//! Path normalization, symlink resolution, and atomic writes shared across DarwinCode crates.
...
/// Compare paths after applying DarwinCode's filesystem normalization.
///
