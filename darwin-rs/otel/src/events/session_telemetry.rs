...
pub struct AuthEnvTelemetryMetadata {
    ...
    pub darwin_code_api_key_env_present: bool,
    pub darwin_code_api_key_env_enabled: bool,
    ...
    pub fn conversation_starts(
        ...
        log_and_trace_event!(
            ...
            common: {
                ...
                auth.env_darwin_code_api_key_present = self.metadata.auth_env.darwin_code_api_key_env_present,
                auth.env_darwin_code_api_key_enabled = self.metadata.auth_env.darwin_code_api_key_env_enabled,
