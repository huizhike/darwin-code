pub(crate) const OTEL_TARGET_PREFIX: &str = "darwin_code_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "darwin_code_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "darwin_code_otel.trace_safe";
