...
pub enum Feature {
    ...
    ChildAgentsMd,
    /// Compress request bodies (zstd) when sending streaming requests to darwin-code-backend.
    ...
    /// Enable plugins.
    Plugins,
    /// Show the startup prompt for migrating external agent config into DarwinCode.
    ExternalMigration,
    ...
    match feature {
        ...
        _ => {
            ...
            let details = if alias == canonical {
                ...
                Some(format!(
                    "Enable it with `--enable {canonical}` or `[features].{canonical}` in config.toml. See https://docs.darwin.local/darwin-code/config-basic#feature-flags for details."
                ))
            };
            (summary, details)
        }
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: JavaScript REPL is now available in /experimental. Enable it, then start a new chat or restart DarwinCode to use it.",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        id: Feature::DarwinCodeGitCommit,
        key: "darwin_code_git_commit",
        stage: Stage::UnderDevelopment,
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            name: "Memories",
            menu_description: "Allow DarwinCode to create new memories from conversations and bring relevant memories into new conversations.",
            announcement: "NEW: DarwinCode can now generate and uses memories. Try is now with `/memories`",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        id: Feature::DarwinCodeHooks,
        key: "darwin_code_hooks",
        stage: Stage::UnderDevelopment,
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            menu_description: "Show a startup prompt when DarwinCode detects migratable external agent config for this machine or project.",
            announcement: "",
        },
        default_enabled: false,
    },
    ...
    FeatureSpec {
        ...
        stage: if cfg!(any(
            ...
            Stage::Experimental {
                ...
                menu_description: "Keep your computer awake while DarwinCode is running a thread.",
