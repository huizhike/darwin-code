...
- Retrieval bias: preserve distinctive nouns and verbatim strings that a future grep/search
  ...
  `api.provider.example/v1/files`, `Provider Internal Slack`, etc.).
...
- Typical workflows and tools (how they like to work, how they use Darwin-Code/agents, preferred formats)
