...
use darwin_code_analytics::CompactionImplementation;
use darwin_code_analytics::CompactionPhase;
use darwin_code_analytics::CompactionReason;
use darwin_code_analytics::CompactionStatus;
use darwin_code_analytics::CompactionStrategy;
use darwin_code_analytics::CompactionTrigger;
use darwin_code_analytics::DarwinCodeCompactionEvent;
use darwin_code_analytics::now_unix_seconds;
...
async fn run_compact_task_inner_impl(
    ...
    loop {
        ...
        match attempt_result {
            ...
            Err(DarwinCodeErr::Interrupted) => {
                return Err(DarwinCodeErr::Interrupted);
            }
            Err(e @ DarwinCodeErr::ContextWindowExceeded) => {
                if turn_input_len > 1 {
...
async fn drain_to_completed(
    ...
    loop {
        ...
        let Some(event) = maybe_event else {
            return Err(DarwinCodeErr::Stream(
