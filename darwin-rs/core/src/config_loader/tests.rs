    ...
    assert_eq!(
        vec![&ConfigLayerEntry {
            name: super::ConfigLayerSource::Project {
                dot_darwin_code_folder: AbsolutePathBuf::from_absolute_path(
...
"#;
    ...
    async fn loads_requirements_exec_policy_without_rules_files() -> anyhow::Result<()> {
        ...
        let config_stack = config_stack_for_dot_darwin_code_folder_with_requirements(
            temp_dir.path(),
            requirements,
        );
