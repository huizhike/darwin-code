...
//! `EscalateRequest` over the inherited `DARWIN_CODE_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `DARWIN_CODE_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
