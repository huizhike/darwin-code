...
use darwin_code_protocol::config_types::WebSearchFilters as ConfigWebSearchFilters;
use darwin_code_protocol::config_types::WebSearchMode;
use darwin_code_protocol::config_types::WebSearchUserLocation as ConfigWebSearchUserLocation;
use darwin_code_protocol::config_types::WebSearchUserLocationType;
...
/// When serialized as JSON, this produces a valid tool declaration for the
/// Responses API.
